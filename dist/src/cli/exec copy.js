...
const colors = ['yellowBright', 'cyanBright', 'blueBright', 'greenBright', 'magentaBright'];
    ...
    function action() {
        ...
        if (isParallel) {
            ...
            children.forEach(child => {
                ...
                const num = utils_1.randomNumber(0, colors.length, nums);
                nums.push(num);
                const transform = ansi_colors_1.default[scope.color] || ansi_colors_1.default[colors[num]];
...
//# sourceMappingURL=exec copy.js.map